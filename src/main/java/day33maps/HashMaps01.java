...
public class HashMaps01 {
    ...
    /*
        1) Map'lerde "USA = 400,000,000" seklinde data depolamamiz gerektiğinde kullanilir.
    ...
    public static void main(String[] args) {
        ...
        hm.put("Myanmar",null);
        hm.put("Bhutan",null);
        System.out.println(hm);//{null=18000000, Myanmar=null, Usa=400000000, Bhutan=null, Germany=850000000, Albania=28000000}
        ...
        //HashMap'lerde belirli bir "key" nin "value" sunu nasil alırız?
        Integer usaPopulation = hm.get("USA");
        System.out.println(usaPopulation);//400000000

        //HashMap'lerde replace()methodu var olan bir "key" nin "value" sunu değiştirmek için kullanilir
        hm.replace("Bhutan",35000000);
        System.out.println(hm);//{null=18000000, Myanmar=null, Usa=400000000, Bhutan=35000000, Germany=850000000, Albania=28000000}

        hm.putIfAbsent("USA",700000000);
        System.out.println(hm);//{null=18000000, Myanmar=null, USA=400000000, Bhutan=35000000, Germany=850000000, Albania=28000000}

        hm.putIfAbsent("India",700000000);
        System.out.println(hm);//{null=18000000, Myanmar=null, USA=400000000, Bhutan=35000000, Germany=850000000, Albania=28000000, India=700000000}

        //Exapmle 2: Yeni öğretmenin maaşı standart ucretten 1000TL fazla, eski öğretmenin maasi standart ucretten 2000TL fazla olsun
        ...
        //hm.replace("USA",400000000,500000000) methodu key USA ve value 400000000 ise value 500000000 yapar
        hm.replace("USA",400000000,500000000);
        System.out.println(hm);//{null=18000000, Myanmar=null, USA=500000000, Bhutan=35000000, Germany=850000000, Albania=28000000, India=700000000}
        ...
        System.out.println(r);// key içinde varsa ==> 35000000 yoksa ==> 0
